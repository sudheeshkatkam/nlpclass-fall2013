  ...
  \item The forward pass
    \begin{itemize}
      ...
      \item Compute, for each potential tag value $k$ of \tcurr\ in the sentence, the highest probability sequence of tags for the previous $i$-1 words and ending with $t_i=k$, given \textit{all possible ways of tagging the $i$-1 previous words}.
        \[
          v_i(k) = \text{max}_{t_1, ..., t_{i-1}}~p(t_1, ..., t_{i-1}, w_1, ..., w_{i-1}, t_i=k \mid \text{HMM})
        \]
...
\tikzstyle{box}=[rectangle, draw=black!100]
  ...
  \path (startstart) edge [connect, dotted] (Dthe);
  \path (startstart) edge [connect, dotted] (Nthe);
  \path (startstart) edge [connect, dotted] (Vthe);
...
\end{tikzpicture}
\caption{Find the maximum probability leading to dog$|$D.  Dotted arrows give the best known path to get to the node.}
\end{figure} 
...
\tikzstyle{box}=[rectangle, draw=black!100]
  ...
  \path (startstart) edge [connect, dotted] (Nthe);
  \path (startstart) edge [connect, dotted] (Vthe);
  \path (Dthe) edge [connect, dotted] (Ddog);
...
\tikzstyle{box}=[rectangle, draw=black!100]
  ...
  \path (startstart) edge [connect, dotted] (Vthe);
  \path (Dthe) edge [connect, dotted] (Ddog);
  \path (Dthe) edge [connect, dotted] (Ndog);
...
\tikzstyle{box}=[rectangle, draw=black!100]
  ...
  \path (Dthe) edge [connect, dotted] (Ddog);
  \path (Dthe) edge [connect, dotted] (Ndog);
  \path (Dthe) edge [connect, dotted] (Vdog);
...
\tikzstyle{box}=[rectangle, draw=black!100]
  ...
  \path (Dthe) edge [connect, dotted] (Ndog);
  \path (Dthe) edge [connect, dotted] (Vdog);
  \path (Ndog) edge [connect, dotted] (Druns);
...
\tikzstyle{box}=[rectangle, draw=black!100]
  ...
  \path (Dthe) edge [connect, dotted] (Vdog);
  \path (Ndog) edge [connect, dotted] (Druns);
  \path (Ndog) edge [connect, dotted] (Nruns);
...
\tikzstyle{box}=[rectangle, draw=black!100]
  ...
  \path (Ndog) edge [connect, dotted] (Druns);
  \path (Ndog) edge [connect, dotted] (Nruns);
  \path (Ndog) edge [connect, dotted] (Vruns);
...
\tikzstyle{box}=[rectangle, draw=black!100]
  ...
  \path (Ndog) edge [connect, dotted] (Nruns);
  \path (Ndog) edge [connect, dotted] (Vruns);
  \path (Vruns) edge [connect, dotted] (endend);
