...
\tikzstyle{box}=[rectangle, draw=black!100]
  ...
  \node[hidden] (startdog)  [below of =dog]       {};
  \node[main] (Ddog)        [below of =startdog]  {0.002};
  \node[draw, draw=white] at ([shift={(55:-0.67)}]Ddog) {\color{black!60!green}0.00016};
  \node[main, fill=white!50!green] (Ndog)        [below of =Ddog]      {0.08};
  \node[draw, fill=white!50!green] at ([shift={(55:-0.67)}]Ndog) {\color{black!60!green}0.04640};
  \node[main] (Vdog)        [below of =Ndog]      {0.002};
  \node[draw, draw=white] at ([shift={(55:-0.67)}]Vdog) {\color{black!60!green}0.0002};
  \node[hidden] (enddog)    [below of =Vdog]      {};
...
\tikzstyle{box}=[rectangle, draw=black!100]
  ...
  \node[draw, fill=white!50!green] at ([shift={(55:-0.67)}]Dthe) {\color{black!60!green}0.2775};
  \node[main] (Nthe)        [below of =Dthe]      {0.007};
  \node[draw, draw=white] at ([shift={(55:-0.67)}]Nthe) {\color{black!60!green}0.0006};
  \node[main] (Vthe)        [below of =Nthe]      {0.008};
  \node[draw, draw=white] at ([shift={(55:-0.67)}]Vthe) {\color{black!60!green}0.0008};
  \node[hidden] (endthe)    [below of =Vthe]      {};
