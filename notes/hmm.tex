...
\end{tikzpicture}
\caption{Calculate $v_2(N)$ and find the best path to it, which turns out to be the path ending with $t_1=D$.}
\end{figure} 
...
\end{tikzpicture}
\caption{Calculate $v_2(V)$ and find the best path to it, which turns out to be the path ending with $t_1=D$}
\end{figure} 
...
\end{tikzpicture}
\caption{Calculate $v_3(D)$ and find the best path to it, which turns out to be the path ending with $t_2=N$}
\end{figure} 
...
\end{tikzpicture}
\caption{Calculate $v_3(N)$ and find the best path to it, which turns out to be the path ending with $t_2=N$}
\end{figure} 
...
\end{tikzpicture}
\caption{Calculate $v_3(V)$ and find the best path to it, which turns out to be the path ending with $t_2=N$}
\end{figure} 
...
\end{tikzpicture}
\caption{For each tag $t_{i+1}$, we examine the backpointer that indicates the way to the best path to $t_{i+1}$, and choose $t_i$ accordingly.}
\end{figure} 
